		...
		<footer className="footer-distributed">
			...
			<div className="footer-right">
				...
				<div className="footer-icons">
					<Link to="/" href="#"><i className="fa fa-facebook"></i></Link>
					<Link to="/" href="#"><i className="fa fa-twitter"></i></Link>
					<Link to="/" href="#"><i className="fa fa-instagram"></i></Link>
					<Link to="/" href="#"><i className="fa fa-linkedin"></i></Link>
					<Link to="/" href="#"><i className="fa fa-youtube"></i></Link>
				</div>
			</div>
		</footer>
	</body>

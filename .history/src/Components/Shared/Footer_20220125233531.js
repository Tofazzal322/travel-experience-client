		...
		<footer className="footer-distributed">
			...
			<div className="footer-right">
				...
				<div className="footer-icons">
					<Link to="/" href="#"><i className="fa fa-facebook"></i></>
					<Link to="/" href="#"><i className="fa fa-twitter"></i></>
					<Link to="/" href="#"><i className="fa fa-instagram"></i></a>
					<Link to="/" href="#"><i className="fa fa-linkedin"></i></>
					<Link to="/" href="#"><i className="fa fa-youtube"></i></>
				</div>
			</div>
		</footer>
	</body>

		...
		<footer className="footer-distributed">
			...
			<div className="footer-right">
				...
				<div className="footer-icons">
					<a href='' ><i className="fa fa-facebook"></i></Link>
					<a href='' ><i className="fa fa-twitter"></i></Link>
					<a href='' ><i className="fa fa-instagram"></i></Link>
					<a href='' ><i className="fa fa-linkedin"></i></Link>

...
import "./Footer.css";
import logo from "../../images/dionne-brown-dcb-travel-experience-logo-full-color-rgb.png";
    ...
    <body>
      <footer className="footer-distributed">
        <div className="footer-left text-light">
          <img className="footer-logo text-light bg-light" alt="logo" src={logo} />
          <h3>
        ...
        <div className="footer-right">
          <p className="footer-company-about">
            ...
            to 100 million consumers daily in 56 countries.{" "}
          </p>

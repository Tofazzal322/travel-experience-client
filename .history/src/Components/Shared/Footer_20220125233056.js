    ...
    return (
		...
		<footer className="footer-distributed">
			<div className="footer-left text-light">
                    <img classNameName='text-light bg-light p-2' alt="logo" src={logo}/>
				<h3>About<span>Travel</span></h3>
				<p className="footer-links">
					<a classNameName='footer-link'>Home</a>
					<a classNameName='footer-link'>Blog</a>
					<a classNameName='footer-link'>About</a>
					<a classNameName='footer-link'>Contact</a>
				</p>

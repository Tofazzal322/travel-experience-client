		...
		<footer className="footer-distributed">
			...
			<div className="footer-right">
				...
				<div className="footer-icons">
					<Link to="" href="#"><i className="fa fa-facebook"></i></a>
					<Link to="" href="#"><i className="fa fa-twitter"></i></a>
					<Link to="" href="#"><i className="fa fa-instagram"></i></a>
					<Link to="" href="#"><i className="fa fa-linkedin"></i></a>
					<Link to="" href="#"><i className="fa fa-youtube"></i></a>
				</div>
			</div>
		</footer>
	</body>

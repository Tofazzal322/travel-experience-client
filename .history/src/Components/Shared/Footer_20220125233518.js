		...
		<footer className="footer-distributed">
			...
			<div className="footer-right">
				...
				<div className="footer-icons">
					<Link href="#"><i className="fa fa-facebook"></i></a>
					<Link href="#"><i className="fa fa-twitter"></i></a>
					<Link href="#"><i className="fa fa-instagram"></i></a>
					<Link href="#"><i className="fa fa-linkedin"></i></a>
					<Link href="#"><i className="fa fa-youtube"></i></a>
				</div>
			</div>
		</footer>
	</body>

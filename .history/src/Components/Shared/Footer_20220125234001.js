		...
		<footer className="footer-distributed">
			...
			<div className="footer-right">
				...
				<div className="footer-icons">
					<a href='https://www.facebook.com/thopu.ahamed32/'><i className="fa fa-facebook"></i></a>
					<a href='https://www.facebook.com/thopu.ahamed32/'><i className="fa fa-twitter"></i></a>
					<a href='https://www.facebook.com/thopu.ahamed32/'><i className="fa fa-instagram"></i></a>
					<a href='https://www.linkedin.com/in/tofazzal-k-829241227/'><i className="fa fa-linkedin"></i></a>

    ...
    <div className="container-fluid mt-5">
      <Row>
        ...
        <Col md={2} className="">
          ...
          <div className=" categories-img">Animal</div>
          <div className=" categories-img mt-2">Food</div>
          <div className=" categories-img mt-2">Health</div>
          <div className=" categories-img mt-2">Sports</div>
          <div className=" categories-img mt-2">Tours</div>
          <div className=" categories-img mt-2">Travel</div>
        </Col>
      </Row>
    </div>
  );

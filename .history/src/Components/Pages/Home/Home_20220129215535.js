...
import images3 from "../../../images/blog_62-200x200.jpg";
import images4 from "../../../images/blog_62-200x200.jpg";
        ...
        <Col>
          ...
          <div>
            <div className="img-top">
              ...
              <h3>African Nation Are Struggling <br /> To Save Their Wildlife</h3>
        ...
        <Col>
          <Row className="mb-2">
            <div className="d-flex">
              <div>
                <img className="rounded" src={images} alt="" />
              </div>

        ...
        <Col>
          <Row className="mb-2">
            <div className="d-flex">
              ...
              <div className="ms-3">
                <p className="bg-primary text-light w-25 px-1 rounded"> Europe</p>
                <h3>
          ...
          <Row className="mb-2">
            <div className="d-flex">
              ...
              <div className="ms-3">
                <p className="bg-danger text-light w-25 px-1 rounded"> Europe</p>
                <h3>
                  African Nation Are <br /> Struggling To Save <br />
                  Their Wildlife
                </h3>
          ...
          <Row>
            <div className="d-flex">
              ...
              <div className="ms-3">
                <p className="bg-warning text-light w-25 px-1 rounded"> Europe</p>
                <h3>
                  African Nation Are <br /> Struggling To Save <br />
                  Their Wildlife
                </h3>

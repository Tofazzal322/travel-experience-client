      ...
      <Row className="mt-3 container-fluid">
        <Col className="" md={3}>
          <Col className="text-size d-flex my-2 ">
            <img className="banner-img mt-2" src={images1} alt="" />
            <div className="ms-4">
        ...
        <Col className="" md={3}>
          <Col className="text-size d-flex my-2 ">
            <img className="banner-img mt-2" src={images2} alt="" />
            <div className="ms-4">
        ...
        <Col className="" md={3}>
          <Col className="text-size d-flex my-2 ">
            <img className="banner-img mt-2" src={images3} alt="" />
            <div className="ms-4">
        ...
        <Col className="" md={3}>
          <Col className="text-size d-flex my-2 ">
            <img className="banner-img mt-2" src={images4} alt="" />
            <div className="ms-4">
